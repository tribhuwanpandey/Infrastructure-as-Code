...
```hcl
   provider "aws" {
     region = "us-east-1"  # Desired AWS region as per requirement
   }

   resource "aws_instance" "example" {
     ami           = "ami-0b09ffb6d8b58ca91"  # Specify an appropriate AMI ID
...
![alt text](<Screenshot 2025-09-12 143746.png>)
